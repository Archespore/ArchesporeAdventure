...
public class RainofArrowsEnchantment extends SpecialEnchantment {

	public RainofArrowsEnchantment(NamespacedKey enchID) {
		super(enchID);
	}
	...
	/**
	 * Adds the rainofarrows metadata to arrows shot.
	...
	public boolean enchantmentEffect(Event event) {
		if (event instanceof EntityShootBowEvent) {
			...
			if (projectile instanceof Arrow) {
				...
				arrowProjectile.setMetadata("RAINOFARROWS", new FixedMetadataValue(ArchesporeAdventureMain.getPlugin(), enchantmentLevel));
				return true;
			}
		}
		return false;
