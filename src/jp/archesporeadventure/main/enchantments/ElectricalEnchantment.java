...
public class ElectricalEnchantment extends SpecialEnchantment {

	public ElectricalEnchantment(NamespacedKey enchID) {
		super(enchID);
	}
	...
	/**
	 * Adds the electrical metadata to arrows shot.
	...
	public boolean enchantmentEffect(Event event) {
		if (event instanceof EntityShootBowEvent) {
			...
			if (projectile instanceof Arrow) {
				...
				arrowProjectile.setMetadata("ELECTRICAL", new FixedMetadataValue(ArchesporeAdventureMain.getPlugin(), enchantmentLevel));
				return true;
			}
		}
		return false;
